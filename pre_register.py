...
def pre():
    ...
    df = df[df['procedure_name_en'] == 'Sell - Pre registration']
    ...
    with b:
        ...
        st.altair_chart(
            ...
            ,  use_container_width=True
    , )
        st.write("The area called :blue[Wadi Al Safa 5] that contain property with high produce area.This area is well known for properties tradings.")
